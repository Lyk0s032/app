        ...
        <SafeAreaView style={{marginTop:30,backgroundColor:'white',height:'100%'}}>
            ...
            <ScrollView>
                <View style={{marginLeft:'5%',marginTop:20, width:'90%', marginBottom:100}}>
                    <Text style={{fontSize:16,color: 'black',marginTop:10, fontWeight:'bold'}}>Términos y condiciones</Text>
                    <Text style={{fontSize:12,color: '#666',marginTop:10}}>
                        Puedes obtener toda la información sobre nuestros términos y condiciones descargando toda la información con el siguiente botón.
                    </Text>
                    <TouchableHighlight style={{padding:10,width:'80%', borderWidth:1,borderRadius:5,borderColor:'#ccc',marginTop:40}}>
                        <Text style={{color: '#666',fontSize:14,textAlign:'center'}}>Términos y condiciones</Text>
                    </TouchableHighlight>
